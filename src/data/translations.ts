...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    // Core Navigation & Dock
    navHome: "Home",
    navEmergency: "Emergency 24x7",
    navProfile: "My Health Card",
    navLocation: "Location Info",
    navNeeds: "Healthcare Needs",
    navSettings: "Language & Settings",
    navAdmin: "Secret Admin",

    // Medical Card
    medicalCardTitle: "My Emergency Medical Card",
    medicalCardSubtitle: "Stored offline on your phone for instant access during emergencies or triage.",
    fullName: "Full Name",
    age: "Age",
    gender: "Gender",
    bloodGroup: "Blood Group",
    emergencyKinName: "Emergency Kin / Family Name",
    emergencyKinPhone: "Emergency Contact Number",
    healthConditions: "Known Medical Conditions",
    schemeIdLabel: "PMJAY / Aarogyasri ID (Optional)",
    saveHealthCard: "Save Emergency Medical Card",
    healthCardSavedSuccess: "Emergency medical profile saved securely on this phone!",
    emergencyPassTitle: "OFFLINE EMERGENCY PASS",
    callKin: "Call Emergency Kin",
    noProfileYet: "Create your Emergency Medical Card so doctors and ambulance staff can access your blood group and emergency contacts even offline.",
    ...
    secretAdminGateTitle: "Enter Admin Passcode",
    secretAdminGateSubtitle: "This area is restricted to state and district health administrators for registry updates and dataset expansion.",
    enterPinPlaceholder: "Enter 7-digit PIN (default: sih2026)",
    unlockBtn: "Unlock Admin Dashboard",
    lockBtn: "Lock Admin",
    importSectionTitle: "Import Dataset & Expand State Coverage",
    importSubtitle: "Upload CSV or Excel (.xlsx) file with public facility records to expand system coverage.",
    dragDropCsv: "Drag & drop CSV or Excel (.xlsx) spreadsheet here, or browse",
    downloadTemplate: "Download CSV Template",
    exportMasterSeed: "Export Master Seed (JSON)",
  ...
  mr: {
    ...
    liveGpsActive: "थेट GPS सक्रिय",

    // Core Navigation & Dock
    navHome: "मुख्य",
    navEmergency: "२४x७ आपत्कालीन",
    navProfile: "माझे आरोग्य कार्ड",
    navLocation: "ठिकाण माहिती",
    navNeeds: "आरोग्य गरजा",
    navSettings: "भाषा व सेटिंग्ज",
    navAdmin: "प्रशासक",

    // Medical Card
    medicalCardTitle: "माझे आपत्कालीन आरोग्य कार्ड",
    medicalCardSubtitle: "इंटरनेट नसतानाही तात्काळ उपचारासाठी आपल्या फोनमध्ये सुरक्षित जतन.",
    fullName: "पूर्ण नाव",
    age: "वय",
    gender: "लिंग",
    bloodGroup: "रक्तगट (Blood Group)",
    emergencyKinName: "नातेवाईकाचे / पालकाचे नाव",
    emergencyKinPhone: "आपत्कालीन फोन नंबर",
    healthConditions: "जुने आजार / विशेष स्थिती (उदा. गरोदरपण, मधुमेह)",
    schemeIdLabel: "महात्मा फुले जन आरोग्य / PMJAY नंबर (ऐच्छिक)",
    saveHealthCard: "आरोग्य कार्ड जतन करा",
    healthCardSavedSuccess: "आपत्कालीन आरोग्य कार्ड फोनमध्ये सुरक्षित जतन झाले!",
    emergencyPassTitle: "ऑफलाइन आपत्कालीन पास",
    callKin: "नातेवाईकाला कॉल करा",
    noProfileYet: "आपले आपत्कालीन आरोग्य कार्ड तयार करा जेणेकरून रुग्णवाहिका किंवा डॉक्टरांना रक्तगट लगेच समजेल.",
    ...
    secretAdminGateTitle: "प्रशासक पासवर्ड प्रविष्ट करा",
    secretAdminGateSubtitle: "हा भाग केवळ आरोग्य अधिकारी व व्यवस्थापकांसाठी राखीव आहे.",
    enterPinPlaceholder: "पासकोड प्रविष्ट करा (उदा. sih2026)",
    unlockBtn: "डॅशबोर्ड अनलॉक करा",
    lockBtn: "प्रशासक लॉक करा",
    importSectionTitle: "डेटा आयात व राज्य विस्तार",
    importSubtitle: "नवीन राज्यांचा किंवा रुग्णालयांचा डेटा जोडण्यासाठी CSV किंवा Excel फाइल अपलोड करा.",
    dragDropCsv: "CSV किंवा Excel (.xlsx) फाइल येथे ड्रॅग करा किंवा निवडा",
    downloadTemplate: "CSV नमुना फाइल डाउनलोड करा",
    exportMasterSeed: "मास्टर डेटा डाउनलोड करा (JSON)",
  ...
  te: {
    ...
    liveGpsActive: "లైవ్ GPS యాక్టివ్",

    // Core Navigation & Dock
    navHome: "హోమ్",
    navEmergency: "24x7 అత్యవసరం",
    navProfile: "నా ఆరోగ్య కార్డు",
    navLocation: "లొకేషన్ వివరాలు",
    navNeeds: "ఆరోగ్య అవసరాలు",
    navSettings: "భాష & సెట్టింగ్స్",
    navAdmin: "అడ్మిన్",

    // Medical Card
    medicalCardTitle: "నా ఎమర్జెన్సీ ఆరోగ్య కార్డు",
    medicalCardSubtitle: "ఇంటర్నెట్ లేకపోయినా అత్యవసర సమయాల్లో చూపేందుకు మీ ఫోన్‌లో భద్రపరచబడింది.",
    fullName: "పూర్తి పేరు",
    age: "వయస్సు",
    gender: "లింగం",
    bloodGroup: "రక్త వర్గం (Blood Group)",
    emergencyKinName: "కుటుంబ సభ్యుల / ఆప్తుల పేరు",
    emergencyKinPhone: "అత్యవసర ఫోన్ నంబర్",
    healthConditions: "ఆరోగ్య సమస్యలు / గర్భధారణ వివరాలు",
    schemeIdLabel: "ఆరోగ్యశ్రీ / PMJAY కార్డు నంబర్ (ఐచ్ఛికం)",
    saveHealthCard: "ఆరోగ్య కార్డును భద్రపరచండి",
    healthCardSavedSuccess: "మీ ఎమర్జెన్సీ ఆరోగ్య కార్డు విజయవంతంగా సేవ్ చేయబడింది!",
    emergencyPassTitle: "ఆఫ్‌లైన్ ఎమర్జెన్సీ పాస్",
    callKin: "కుటుంబ సభ్యునికి కాల్ చేయండి",
    noProfileYet: "డాక్టర్లకు మీ రక్త వర్గం మరియు సమాచారం త్వరగా తెలిసేలా మీ ఎమర్జెన్సీ కార్డును భద్రపరచండి.",
    ...
    secretAdminGateTitle: "అడ్మిన్ పాస్‌వర్డ్ ఎంటర్ చేయండి",
    secretAdminGateSubtitle: "ఈ విభాగం కేవలం జిల్లా ఆరోగ్య అధికారుల కోసం మాత్రమే కేటాయించబడింది.",
    enterPinPlaceholder: "పాస్‌కోడ్ ఎంటర్ చేయండి (ఉదా. sih2026)",
    unlockBtn: "అన్‌లాక్ చేయండి",
    lockBtn: "అడ్మిన్ లాక్ చేయండి",
    importSectionTitle: "డేటా దిగుమతి & రాష్ట్ర విస్తరణ",
    importSubtitle: "కొత్త రాష్ట్రాల లేదా ఆసుపత్రుల వివరాలను జోడించడానికి CSV లేదా Excel (.xlsx) ఫైల్ అప్‌లోడ్ చేయండి.",
    dragDropCsv: "CSV లేదా Excel ఫైల్‌ను ఇక్కడ డ్రాప్ చేయండి",
    downloadTemplate: "CSV టెంప్లేట్ డౌన్‌లోడ్",
    exportMasterSeed: "మాస్టర్ డేటా ఎగుమతి (JSON)",
